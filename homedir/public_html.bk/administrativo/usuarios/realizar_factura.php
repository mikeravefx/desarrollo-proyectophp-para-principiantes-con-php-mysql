...
$result = mysql_query("SELECT * FROM courierp_miembros.tracking WHERE cedula = '".$_POST['cedula']."'"." and statusvenezuela LIKE '%En%Almacen%VZLA%'", $link);
$contador=0;
$consolidacion=0;
...
{
if ($check == 0) {
                   die('<br><br><br><br><br><br><br><p align="left"><strong>ERROR: Este Usuario no existe en nuestra base de datos. <a href=cedulin.html>Intente de Nuevo</a></strong></p>');
                   }
...
echo "<p align='left'><img src='bizama.png' width='200' height='75'></p>\n ";
echo " <div align='left'>\n ";
