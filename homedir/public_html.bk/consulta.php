...
$result = mysql_query("SELECT * FROM courierp_miembros.tracking WHERE guiacliente = '".$_GET['guiacliente']."'", $link);
...
echo "<td colspan='2'><div align='center' class='style1'>Detalles de Su Orden</div></td>\n";
...
do {
echo "<tr> \n";
echo " <td width='243' bgcolor='#FFFFFF'><span class='style1'>Nombre y Apellido:</span></td> \n";
echo "<td width='334'><span class='style1'><strong>".$row["nomape"]." </strong></span></td> \n";
echo "</tr> \n";
echo " <tr> \n";
echo "<td bgcolor='#FFFFFF'><span class='style1'>Correo:</span></td>";
echo " <td><span class='style1'><strong>".$row["correo"]."</strong></span></td> \n";
echo "</tr> \n";
echo "<td bgcolor='#FFFFFF'><span class='style1'>Fecha de Llegada a miami:</span></td>";
echo " <td><span class='style1'><strong>".$row["fecha"]."</strong></span></td> \n";
echo "</tr> \n";
echo "</tr> \n";
echo "<td bgcolor='#FFFFFF'><span class='style1'>Remitente:</span></td>";
echo " <td><span class='style1'><strong>".$row["remitente"]."</strong></span></td> \n";
echo "</tr> \n";
echo "</tr> \n";
echo "<td bgcolor='#FFFFFF'><span class='style1'>Articulo(s):</span></td>";
echo " <td><span class='style1'><strong>".$row["articulos"]."</strong></span></td> \n";
echo "</tr> \n";
echo "</tr> \n";
echo "<td bgcolor='#FFFFFF'><span class='style1'>Empresa de envío interno:</span></td>";
echo " <td><span class='style1'><strong>".$row["empresa"]."</strong></span></td> \n";
echo "</tr> \n";
echo "</tr> \n";
echo "<td bgcolor='#FFFFFF'><span class='style1'>Numero trancking:</span></td>";
echo " <td><span class='style1'><strong>".$row["tracking"]."</strong></span></td> \n";
echo "</tr> \n";
echo "</tr> \n";

echo "<td bgcolor='#FFFFFF'><span class='style1'>Guia de Su Carga:</span></td>";
echo " <td><span class='style1'><strong><a href='http://www.courierpack.com.ve/consulta_estatus_por_guia.php?guiacliente=".$row["guiacliente"]."'>".$row["guiacliente"]." Click aqui para consultar estatus </a></strong></span></td> \n";
echo "</tr> \n";
//statusvenezuela
echo "</tr> \n";
...
<div id='next'><ul>
 ...
 ¡ Registro no Encontrado Intente de Nuevo !      </CENTER>
     <li class='pagenav style1'></li>
      <li class='pagenav style1'></li>
      <li class='pagenav style1'></li>
      </ul>
