...
$link = mysql_connect("localhost", "bizgloba_webmast", "mikex5761880n");
...
do {
// id 	nomape 	cedula 	correo 	fecha 	guiacliente 	statusvenezuela fechaestimada 	fecharecep articulos 	tracking 	statususa 	numerorden
echo "<tr> \n";
echo "<td>".$row["id"]."</td>";
echo "</tr> \n";
...
echo "</tr> \n";
echo "<td>".$row["fecharecep"]."</td>";
echo "</tr> \n";
echo "<td>".$row["articulos "]."</td>";
echo "</tr> \n";
echo "<td>".$row["tracking"]."</td>";
echo "</tr> \n";
echo "<td>".$row["statususa"]."</td>";
echo "</tr> \n";
echo "<td>".$row["numerorden"]."</td>";
echo "</tr> \n";
echo "<td>".$row["articulos"]."</td>";
echo "</tr> \n";
echo "</tr> \n";
