...
$result = mysql_query("SELECT * FROM courierp_miembros.tracking WHERE cedula = '".$SESSION['cedula']."'", $link);
if ($row = mysql_fetch_array($result)){echo "<!DOCTYPE html PUBLIC '-//W3C//DTD XHTML 1.0 Transitional//EN' 'http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd'>
...
echo "<div align='justify' class='style1'>Sus ordenes de Servicio:<br><br><br>

</div>
<tr>
    <td width='506' bgcolor='#AAD2FF'><span class='style1'>Fecha de recepcion:</td>
    <td width='47' bgcolor='#AAD2FF'><span class='style1'>Articulos:</td>
    <td width='506' bgcolor='#FFFFCC'><span class='style1'>Guía de Carga:</td>
	<td width='506' bgcolor='#FFFFCC'><span class='style1'>Estatus:</td>
	<td width='506' bgcolor='#FFFFCC'><span class='style1'>Fecha Estimada de Entrega:</td></tr>";
...
do {
echo "<tr>
    <td width='506' bgcolor='#AAD2FF'><span class='style1'>".$row["fecha"]."</span></td>
    <td width='506' bgcolor='#AAD2FF'><span class='style1'>".$row["articulos"]."</span></td>
    <td width='506' bgcolor='#FFFFCC'><span class='style1'><a href='http://www.courierpack.com.ve/consulta_estatus_por_guia.php?guiacliente=".$row["guiacliente"]."'>".$row["guiacliente"]." Click aqui para detalles de la guía </a><br></span></td>
	<td width='506' bgcolor='#FFFFCC'><span class='style1'>".$row["statusvenezuela"]."</span></td>
	<td width='506' bgcolor='#FFFFCC'><span class='style1'>".$row["fechaestimada"]."</span></td></tr>"; 
