...
if (!$_POST['nomape_a']| !$_POST['cedula_a'] | !$_POST['empresa_a'] |!$_POST['direccion_a'] |!$_POST['alternativa_a'] |!$_POST['estado_a'] |!$_POST['ciudad_a'] |!$_POST['telfijo_a'] |!$_POST['telcelular_a'] |!$_POST['correo_a'] ) {
...
check_email_address($_POST['username_a']);

///////////////////////////////////////////////////////// DETERMINAR SI UPDATE O NO //////////////////////////////////////////////////

$check1 = mysql_query("SELECT * FROM courierp_miembros.users WHERE username = '".$_POST['username_a']."' AND ID='".$_POST['ID_a']."'")
or die(mysql_error());
$check3 = mysql_num_rows($check1);

if ($check3 != 0 && $row["ID"] != $_POST["ID_a"] && $row["correo"] == $_POST['correo_a']) {    			              
                								  							  
									  die('<br><br><br><br><br><br><br><p align="center"><strong> ERROR: Este Correo pertenece a otro usuario y no esta disponible, </strong><a href=actualizar.php>Intente de Nuevo</a></strong></p>');
									    }		
					else 
...
$update = "UPDATE courierp_miembros.users SET nomape='".$_POST['nomape_a']."',cedula ='".$_POST['cedula_a']."',empresa='".$_POST['empresa_a']."',
direccion='".$_POST['direccion_a']."',alternativa='".$_POST['alternativa_a']."',estado='".$_POST['estado_a']."',ciudad='".$_POST['ciudad_a']."',telfijo='".$_POST['telfijo_a']."',telcelular='".$_POST['telcelular_a']."',correo='".$_POST['correo']."' WHERE ID='".$_POST['ID_a']."'";
...
<table width="55%" border="0">
 ...
 <p align="center" class="style1"><a href="usuarios.php">Regresar</a></p>    </td>
