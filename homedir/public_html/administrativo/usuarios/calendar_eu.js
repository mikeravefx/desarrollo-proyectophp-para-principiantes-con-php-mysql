...
// Public Domain Software... You're welcome. lun mar mie jue vie sab dom
...
function f_tcalParseDate (s_date) {
	...
	if (!re_date.exec(s_date))
		return alert ("Invalid date: '" + s_date + "'.\nEl Formato Aceptado es dd-mm-yy.")
	...
	if (n_month < 1 || n_month > 12)
		return alert ("Invalid month value: '" + n_month + "'.\nEl Rango permitido es de los meses 01 al 12.");
	var d_numdays = new Date(n_year, n_month, 0);
	if (n_day > d_numdays.getDate())
		return alert("Invalid day of month value: '" + n_day + "'.\nEl rango permitido para los meses es 01 - " + d_numdays.getDate() + ".");
...
function f_tcalGenerDate (d_date) {
	return (
		...
		+ d_date.getFullYear().toString().slice(2)
	);
}
