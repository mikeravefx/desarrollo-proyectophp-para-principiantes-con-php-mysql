...
$result = mysql_query("SELECT nomape, correo, fecha, guiacliente,statusvenezuela,fechaestimada FROM bizgloba_miembros.tracking WHERE guiacliente = '".$_POST['guiacliente']."'", $link);
