...
$dbh=mysql_connect ("localhost", "courierp_courier", "hVAC53fjGa7F")

or die ('problema conectando porque :' . mysql_error());

// seleccionado la base de datos

mysql_select_db ("courierp_miembros",$dbh);

// preparando la instruccion sql

$q = "DELETE FROM courierp_miembros.users WHERE ID = '".$_GET['id_a']."'";
...
<div align='center'>
  <p><font face='verdana' size='-2'>:: Usuario Eliminado ::</font></p>
  <p><font face='verdana' size='-2'><a href='usuarios.php'>:: Regresar ::          </a></font> 
