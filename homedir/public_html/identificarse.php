...
session_start();
if(isset($SESSION)){
header("location: zona_usuarios.php"); /* Si ha iniciado la sesion, vamos a user.php */
} else { 
...
<div id="next"><ul><li class="pagenav">
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#FFFCDD" bgcolor="#FFFCDD">
    ...
    <tr>
      <td height="41" align="center" valign="middle" bgcolor="#FFFFFF"><p align="center" class="style50 style59 style1">&nbsp;</p>
<p align="center" class="style1 style59 style50 style3"><strong>Area exclusiva de miembros </strong></p>
<p align="center" class="style1 style59 style50 style3"><strong>Si Usted aun no tiene cuenta <a href="registro_clientes.php">registrese</a> <span class="style59">&raquo;</strong></p>
<p align="center" class="style1 style59 style50 style3"><strong>En Caso Contrario Ingrese Su Correo y Contrase&ntilde;a </strong></p>

<form action="autentificar.php" method="post" class="style59">
<table border="0" align="center">
<tr>
  <td class="style2"><p align="center" class="style4 style1 style59 style50"><strong>Usuario:</strong></p></td><td>
<input name="username" type="text">
</td></tr>
<tr><td class="style2"><p align="center" class="style4 style1 style59 style50"><strong>Contrase&ntilde;a </strong>:</p></td><td>
<input name="pass" type="password">
</td></tr>
<tr><th colspan=2><input name="submit" type="submit" value="Entrar"></th></tr> </table>
</form>
<p class="style3">&nbsp;</p>
<p class="style3">&nbsp;&iquest; Olvido contrase&ntilde;a ? haga click <a href="#">aqui <span class="style59">&raquo;</a></p></td>
    </tr>
  </table>
  </li>
